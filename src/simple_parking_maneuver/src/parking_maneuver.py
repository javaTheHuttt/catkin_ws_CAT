...
class SimpleParkingManeuver:
    ...
    def parking_maneuver(self, request):
        ...
        if request.direction == "left":
            self.driving_maneuver_client.call(direction="backward", steering="left", distance=0.6)
            self.driving_maneuver_client.call(direction="backward", steering="straight", distance=1.8)
            self.driving_maneuver_client.call(direction="backward", steering="right", distance=0.5)
            self.driving_maneuver_client.call(direction="forward", steering="straight", distance=0.2)
        elif request.direction == "right":
            self.driving_maneuver_client.call(direction="backward", steering="straight", distance=0.9)
            self.driving_maneuver_client.call(direction="backward", steering="right", distance=0.6)
            self.driving_maneuver_client.call(direction="backward", steering="left", distance=0.5)
            self.driving_maneuver_client.call(direction="forward", steering="straight", distance=0.2)
        else:
